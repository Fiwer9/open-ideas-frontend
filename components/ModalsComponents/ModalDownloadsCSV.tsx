...
const ModalDownloadsCSV = ({
  ...
  return (
    ...
    >
      ...
      <p className={styles.textCSV}>
        Добавление пользователей с помощью загрузки CSV-файла корректно работает
        только при следующем шаблоне заголовков:
      </p>
      ...
      <div className={styles.upload}>
        <Upload maxCount={1} accept=".csv" className="upload">
