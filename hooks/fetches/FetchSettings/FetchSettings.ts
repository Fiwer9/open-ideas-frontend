...
export default class FetchSettings {
  ...
  static useGetSettings(): [SettingsResponse[], Dispatch<SetStateAction<SettingsResponse[]>>] {
  ...
  static usePutSettings(id: number, allow_file_attachment: boolean, max_file_size: number, max_files_attached: number, anonymous_status: boolean) {
    return SettingsService.putSettings(id, allow_file_attachment, max_file_size, max_files_attached, anonymous_status)
  }
}
